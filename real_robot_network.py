...
class ForceEncoder(nn.Module):
    def __init__(self, force_dim, hidden_dim, batch_size, obs_horizon, force_encoder = "Linear", cross_attn = False, im_encoder = "resnet", train = True):
...
dataset_path = "/home/lm-2023/jeon_team_ws/lbr-stack/src/DP_cable_disconnection/Nist_wrist2cam_terminal.zarr.zip"
