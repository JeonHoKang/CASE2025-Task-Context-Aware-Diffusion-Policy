...
class EvaluateRealRobot:
    ...
    def __init__(self, max_steps, encoder = "resnet", action_def = "delta", force_mod= False, single_view = False, force_encoder = "Linear", force_encode = False, cross_attn = False, hybrid = False):
